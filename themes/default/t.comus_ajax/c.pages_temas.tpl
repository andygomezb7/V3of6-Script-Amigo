...
<div class="com_tema_list clearfix" style="border-left: 4px solid #07f;">
    <div class="ctl_autor floatL">
        <a href="{$tsConfig.direccion_url}/{$t.usuario_nombre}/" title="Ver perfil de {$t.usuario_nombre}"><img src="{$t.w_avatar}" width="32" height="32" /></a>
    </div>
    <div class="ctl_info">
        <a href="{$tsConfig.direccion_url}/foro/{$tsCom.c_nombre_corto}/{$t.t_id}/{$t.t_titulo|seo}.html"><i class="com_icon icon_sticky"></i>{$t.t_titulo}</a>
        <span class="ctli_detalles">Por <a href="{$tsConfig.direccion_url}/{$t.usuario_nombre}/" title="Ver perfil de {$t.usuario_nombre}">{$t.usuario_nombre}</a> {$t.t_fecha|hace}</span>
...
<div class="com_tema_list clearfix" {if $t.t_estado == 1}style="opacity: 0.5;background: #000;" title="El tema ha sido eliminado"{/if}>
    ...
    <div class="ctl_info">
        <a href="{$tsConfig.direccion_url}/foro/{$tsCom.c_nombre_corto}/{$t.t_id}/{$t.t_titulo|seo}.html">{$t.t_titulo}</a>
        <span class="ctli_detalles">Por <a href="{$tsConfig.direccion_url}/{$t.usuario_nombre}/" title="Ver perfil de {$t.usuario_nombre}">{$t.usuario_nombre}</a> {$t.t_fecha|hace}</span>
        <div class="ctli_comment">
            <i class="com_icon icon_comment"></i><span>{$t.t_respuestas}</span>
        </div>
