...
<p>En esta parte de la administración de {$tsConfig.name} puedes administrar el perfil de cada usuario, pero limitado a ciertos campos de su perfil ya que respetamos la privacidad y seguridad de cada perfil, usa muy bien esta parte ya que es una de las <b>10 paginas maestras</b>.</p>
<br><br>
