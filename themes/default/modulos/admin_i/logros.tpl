...
<p>En esta parte de la administración de {$tsConfig.name} puedes administrar los logros que los usuarios podran obtener en sus perfiles, el ego de cada perfil, usa muy bien esta parte ya que es una de las <b>10 paginas maestras</b>.</p>
<br><br>
...
<script type="text/javascript" src="{$tsConfig.url}/js/admod/log_attr.js"></script>
</div></div>