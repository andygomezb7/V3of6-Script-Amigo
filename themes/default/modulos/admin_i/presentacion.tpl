<h2 class="title">Administración global</h2>
<p>Hola <b>@{$u.usuario_nombre}</b>, {if $u.user_sexo == 0}Bienvenido{else}Bienvenida{/if} a la sala de administración global de {$tsConfig.name}.</p>
<br><br>
...
<li class="lsn">Debes evitar que {$tsConfig.name} sea blanco f&iacute;cil de spam, insultos, crap etc.</li>
