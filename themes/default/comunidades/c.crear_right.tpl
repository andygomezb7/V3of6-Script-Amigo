...
{/literal}
	...
	<div class="com_box_title clearfix"><h2>Imagen de el foro</h2></div>
    ...
    <div class="com_box_title clearfix"><h2>Apariencia</h2></div>
    <div class="com_edit_apa">
        <h4>Fondo de el foro</h4>
        <div class="com_edit_imagen" align="center">
        ...
        <a href="javascript:com.borrar({$tsDato.c_id});" class="input_button ibr">Eliminar foro</a>
        {elseif $tsDato.c_estado == 1}
        <a href="javascript:com.borrar({$tsDato.c_id}, 1);" class="input_button">Reactivar foro</a>
        {/if}
    </div>
{else}
    <div class="add_com_sidebar">
        <span class="stitle">Reglas para tu foro</span>
        Para que tu foro sea exitosa te recomendamos tener en cuenta los siguientes puntos:
        <p><strong style="color:#22B447">Un foro SI puede:</strong></p>
        ...
        <p><strong style="color:#822217">Un foro NO puede:</strong></p>
        <ul>	
        ...
        <br><br>
        <strong>Por favor lea el protocolo para evitar sanciones o que tu foro sea eliminada haciendo <a href="{$tsConfig.url}/pages/protocolo/" target="_blank">click aqu&iacute;</a></strong>
        </div>
        <div class="box">
