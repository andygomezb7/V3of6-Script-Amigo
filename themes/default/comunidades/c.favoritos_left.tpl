<div class="com_box_title clearfix"><h2>Mis temas favoritos</h2><div class="cbt_right"><strong>{$tsFavoritos.total}</strong></div></div>
        ...
        <tbody>
            ...
            <tr class="com_category {$f.sub_cat.c_seo}" id="fav_tema_id_{$f.fav_id}">
            	<td align="left">
                    ...
                    <a href="{$tsConfig.url}/foro/{$f.c_nombre_corto}/{$f.t_id}/{$f.t_titulo|seo}.html">{$f.t_titulo}</a>
                </td>
                <td align="left">
                    <a href="{$tsConfig.url}/foro/{$f.c_nombre_corto}/">{$f.c_nombre}</a>
                </td>
