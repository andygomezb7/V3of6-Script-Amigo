...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    */
    ...
    public function __construct()
    {
        ...
        // set default dirs
        $this->setTemplateDir('.' . DS . 'themes' . DS . TS_TEMA . DS)
            ->setCompileDir('.' . DS . 'php' . DS . 'ext' . DS . 'templates_c' . DS)
            ->setPluginsDir(SMARTY_PLUGINS_DIR)
            ->setCacheDir('.' . DS . 'php' . DS . 'ext' . DS . 'cache' . DS)
            ->setConfigDir('.' . DS . 'php' . DS . 'ext' . DS . 'configs' . DS);
